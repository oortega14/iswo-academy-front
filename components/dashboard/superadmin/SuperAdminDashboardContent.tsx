    ...
    <div className="mt-4">
      <div className="flex flex-col items-start justify-between border-b pb-6 lg:flex-row lg:items-center lg:space-y-0">
        <h1 className="ml-3 whitespace-nowrap text-2xl font-semibold ">
          Hola {currentUser?.first_name} aquí tienes algunas estadisticas de la plataforma
        </h1>
      </div>
      <div className="mb-12 mt-10 grid grid-cols-1 gap-x-6 gap-y-10 px-4 md:grid-cols-2">
        <Link href={`/super-admin/${userId}/back-office/courses`}>
          <MotionDiv
        ...
        <Link href={`/super-admin/${userId}/back-office/learning-routes`}>
          <MotionDiv
            whileHover={{ scale: 0.98 }}
            whileTap={{ scale: 0.99 }}
            className="cursor-pointer"
        ...
        <Link href={`/super-admin/${userId}/back-office/academies`}>
          <MotionDiv
            whileHover={{ scale: 0.98 }}
            whileTap={{ scale: 0.99 }}
            className="cursor-pointer"
