...
export const AcademiesStatisticsContent = () => {
  return (
    <div className="mt-4">
      <div className="flex flex-col items-start justify-between border-b pb-6 lg:flex-row lg:items-center lg:space-y-0">
        <h1 className="ml-3 text-2xl font-semibold ">
          A continuación tienes algunas estadisticas de los academias en la
          plataforma
        </h1>
      </div>
        ...
        <div className="m-5 flex w-full space-x-16">
          <div className="flex w-1/2 flex-col items-center justify-center">
            <h2 className="mb-3 text-2xl text-center">
              Academias inscritos a la largo de los años
            </h2>
            <Bar
              data={{
        ...
        <div className="my-10 ml-5 w-2/3">
          ...
          <Line
            data={{
              ...
              datasets: [
                {
                  label: "Academias terminados",
                  data: [200, 310, 400, 200, 500],
                  backgroundColor: "#064FF0",
                  borderColor: "#064FF0",
                },
                {
                  label: "Academias desertados",
...
export default AcademiesStatisticsContent
