...
export const LearningRoutesStatisticsContent = () => {
  return (
    <div className="mt-4">
      <div className="flex flex-col items-start justify-between border-b pb-6 lg:flex-row lg:items-center lg:space-y-0">
        <h1 className="ml-3 text-2xl font-semibold ">
          A continuación tienes algunas estadisticas de las rutas de aprendizaje en la
          plataforma
        </h1>
      </div>
        ...
        <div className="m-5 flex w-full space-x-16">
          <div className="flex w-1/2 flex-col items-center justify-center">
            <h2 className="mb-3 text-center text-2xl">
              Rutas de aprendizaje inscritas a la largo de los años
            </h2>
            <Bar
              data={{
                ...
                datasets: [
                  {
                    label: "Rutas de aprendizaje inscritas",
                    data: [200, 310, 400],
          ...
          <div className="flex w-1/3 flex-col items-center justify-center">
            <h2 className="mb-3 text-center text-2xl">
              Rutas de aprendizaje inscritos a la largo de los años
            </h2>
            <Doughnut
              data={{
                labels: ["2019", "2020", "2021"],
                datasets: [
                  {
                    label: "Rutas de aprendizaje inscritos",
                    data: [200, 310, 400],
                  },
                ],
              }}
        ...
        <div className="my-10 ml-5 w-2/3">
          ...
          <Line
            data={{
              ...
              datasets: [
                {
                  label: "Rutas de aprendizaje terminados",
...
export default LearningRoutesStatisticsContent
