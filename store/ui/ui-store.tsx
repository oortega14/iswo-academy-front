...
export const useUIStore = create<State & Action>()((set)=> ({
  ...
  changeSidebar: () => set((state) => ({ isSidebarOpen: !state.isSidebarOpen})),
  changeSettingsBar: () => set((state) => ({ isSettingsBarOpen: !state.isSettingsBarOpen})),
  changeSearchBar: () => set((state) => ({ isSearchBoxOpen: !state.isSearchBoxOpen})),
  changeNotifications: () => set((state) => ({ isNotificationsOpen: !state.isNotificationsOpen})),
  changeServices: () => set((state) => ({ isServicesOpen: !state.isServicesOpen})),
  changeUserSettings: () => set((state) => ({ isUsersSettingsOpen: !state.isUsersSettingsOpen})),
